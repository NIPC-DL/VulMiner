...
lstm = LSTM(input_size=4, hidden_size=5, batch_first=True, bidirectional=True) # input_dim = 4, hidden_dim = 5
dense = Linear(5*2, 2)
...
o, l = pad_packed_sequence(packed_output, batch_first=True)
print(l-1)
print((l-1).view(-1,1).expand(o.size(0), o.size(2)))
idx = (l-1).view(-1,1).expand(o.size(0), o.size(2)).unsqueeze(1).long()
print(idx)
o = o.gather(1, idx).squeeze().unsqueeze(1)
print(o[:, -1, :])
